 ...
 * @author choqib
 */
public class frmpassresset extends javax.swing.JFrame {

    /**
     * Creates new form frmpassresset
     */
    public frmpassresset() {
        initComponents();
...
tools.openForm(new frmHome());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmpassresset.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmpassresset().setVisible(true);
            }
        });
    }
